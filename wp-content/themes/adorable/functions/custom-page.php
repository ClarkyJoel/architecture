...
function hybrid_page_meta_boxes() {
	...
	$meta_boxes = array(
			'page_title' => array( 
							'name' => 'page_title', 
							'title' => __(' Page Title', 'pego_tr'), 
							'description' => __('Input page title if(OPTIONAL) you want it to be different than the main title of the page. You can use :: to seperate the left and right title side(they are different colors).', 'pego_tr'), 
							'type' => 'text' ),
			'page_template' => array( 
							'name' => 'page_template', 
							...
							'type' => "select", 
							'std' => '',
							'options' => array('', __('Blog','pego_tr'), __('Contact','pego_tr'), __('Home','pego_tr'), __('Portfolio','pego_tr'))),
			'include_category' => array( 
							'name' => 'include_category', 
							'title' => __(' Include category? (for portfolio pages only)', 'pego_tr'), 
							'description' => __('Input categories.', 'pego_tr'), 
							'type' => 'text' ),
			'show_filter' => array( 
							'name' => 'show_filter', 
							'title' => __(' Show filter? (for portfolio pages only)', 'pego_tr'), 
							'description' => __('Show filter?', 'pego_tr'), 
							'type' => "select", 
							'std' => '',
							'options' => array(__('Yes','pego_tr'), __('No','pego_tr'))),
			'external_link' => array( 
							'name' => 'external_link', 
			...
			'show_page_in_menu' => array( 
							...
							'description' => __('Sleect if you want the page to appear in the menu!', 'pego_tr'), 
							'type' => "select", 
							'std' => __('Yes','pego_tr'),
							'options' => array(__('Yes','pego_tr'),__('No','pego_tr')))
	);
