...
function hybrid_post_meta_boxes_portfolio() {
	...
	$meta_boxes = array(
			'portfolio_type_selected' => array( 
							...
							'type' => "select", 
							'std' => __('Image','pego_tr'),
							'options' => array(__('Image','pego_tr'), __('Slideshow','pego_tr'), __('Video','pego_tr'))),
		    'portfolio_opening_type' => array( 
							'name' => 'portfolio_opening_type', 
							'title' => __('Opening Type', 'pego_tr'), 
							'description' => __('Select how you want the portfolio to open.', 'pego_tr'), 
							'type' => "select", 
							'std' => __('PopUp','pego_tr'),
							'options' => array(__('PopUp','pego_tr'), __('Description Page','pego_tr')))
	);
